...
/**
 * APOLLO ENGINE v17.2 - REPLENISHMENT TARGET (Final Polish)
 * STATUS: Calculado contra P100 (Eficiência).
 * MÍDIA VISÍVEL: Card renomeado para "ESTOQUE DE REPOSIÇÃO" focando em P150.
 * REPOSIÇÃO: Calculada para atingir o P150.
 */
...
function processNetwork() {
    console.log("🧬 Iniciando Motor Apollo v17.2 (Finalizando nomenclatura de Reposição)...");
    ...
    for (let storeName in rawData) {
        ...
        networkResults[storeName] = {
            metrics: {
                ...
                estoqueReposicao: replenishTarget, // Renomeado para clareza
                repor: Math.max(0, replenishTarget - avail),
    ...
    console.log("💎 Apollo v17.2 FINAL REPLENISHMENT Processed Successfully.");
}
