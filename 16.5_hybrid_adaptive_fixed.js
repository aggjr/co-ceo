...
/**
 * APOLLO ENGINE v16.5 - HYBRID ELITE (Adaptive + Fixed Scales)
 * Inteligência: Fourier + Slope + Window Adaptativa (730d)
 * Visualização: Escalas Clássicas (P10 a P800) sobre o Pivot Adaptativo.
 * Filtro: Média Móvel 30 dias para fluidez total.
 */
...
function processNetwork() {
    console.log("🧬 Iniciando Motor Apollo v16.5 HÍBRIDO (Inteligência Adaptatória + Escalas Fixas)...");
    ...
    for (let storeName in rawData) {
        ...
        for (let i = 0; i < finalTimelineRaw.length; i++) {
            ...
            finalTimelineFluid.push({
                ...
                p10:  targetBase * 0.1,  // RUPTURA (Piso Sólido)
                p50:  targetBase * 0.5,  // CRÍTICO
                p100: targetBase * 1.0,  // ABAIXO
                p150: targetBase * 1.5,  // ACIMA (IDEAL P150)
                p200: targetBase * 2.0,  // MUITO ACIMA
                p400: targetBase * 4.0,  // ENCALHADO 1
                p800: targetBase * 8.0   // ENCALHADO 2
            });
        }
    ...
    console.log("💎 Apollo v16.5 HYBRID Network Processed Successfully.");
}
