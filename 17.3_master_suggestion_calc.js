...
/**
 * APOLLO ENGINE v17.3 - TRANSFER SUGGESTION
 * STATUS: Calculado contra P100 (Eficiência).
 * REPOSIÇÃO: Alvo em 150% (P150).
 * SUGESTÃO: Disponível - MAX(Reposicao, Minimo). Aceita valores NEGATIVOS.
 */
...
function processNetwork() {
    console.log("🧬 Iniciando Motor Apollo v17.3 (Cálculo de Sugestão com valor negativo)...");
    ...
    for (let storeName in rawData) {
        ...
        // --- NOVA FÓRMULA DE SUGESTÃO v17.3 ---
        // Sugestão = Disponível - MAX(Reposição, Mínimo)
        const sugestaoFinal = avail - Math.max(replenishTarget, MIN_STOCK_USER);
        ...
        networkResults[storeName] = {
            metrics: {
                ...
                estoqueSugestao: sugestaoFinal, // Nova Métrica
    ...
    console.log("💎 Apollo v17.3 SUGGESTION FORMULA Processed Successfully.");
}
